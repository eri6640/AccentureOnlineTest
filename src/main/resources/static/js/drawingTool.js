...
function prepareCanvas()
{
	...
	crayonImage.src = "img/drawingTool/crayon-outline.png";
	//context.drawImage(crayonImage, 0, 0, 100, 100);
	
	markerImage.onload = function() { resourceLoaded(); 
	};
	markerImage.src = "img/drawingTool/marker-outline.png";
	
	eraserImage.onload = function() { resourceLoaded(); 
	};
	eraserImage.src = "img/drawingTool/eraser-outline.png";	
	
	crayonBackgroundImage.onload = function() { resourceLoaded(); 
	};
	crayonBackgroundImage.src = "img/drawingTool/crayon-background.png";
	
	markerBackgroundImage.onload = function() { resourceLoaded(); 
	};
	markerBackgroundImage.src = "img/drawingTool/marker-background.png";
	
	eraserBackgroundImage.onload = function() { resourceLoaded(); 
	};
	eraserBackgroundImage.src = "img/drawingTool/eraser-background.png";

	crayonTextureImage.onload = function() { resourceLoaded(); 
	};
	crayonTextureImage.src = "img/drawingTool/crayon-texture.png";
	
	outlineImage.onload = function() { resourceLoaded(); 
	};
	outlineImage.src = "img/drawingTool/watermelon-duck-outline.png";
